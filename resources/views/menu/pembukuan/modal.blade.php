...
<!-- Delete Modal -->
<div class="modal fade" id="deleteModal{{ $pembukuan->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-white">Apakah anda yakin menghapus Transaksi ini?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Jika anda yakin ingin menghapus Transaksi <strong>{{ $pembukuan->deskripsi }}</strong>, Tekan Oke!
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <form method="POST" action="{{ route('pembukuan.destroy', $pembukuan->id) }}">
                    @csrf
                    @method('DELETE')
