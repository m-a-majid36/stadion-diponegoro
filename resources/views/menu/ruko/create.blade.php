    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah Ruko</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Ruko</h5>
                        ...
                        <form action="{{ route('ruko.store') }}" method="POST">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" style="height: 100px">{{ old('keterangan') }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
